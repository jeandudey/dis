...
impl Id {
    ...
    pub fn mnemonic(self) -> &'static str {
        ...
        match self {
            ...
            LSIU             => "lsiu",
            SSIU             => "ssiu",
            MULA_DD_LL_LDINC => "mula.dd.ll.ldinc",
            MULA_DD_HL_LDINC => "mula.dd.hl.ldinc",
            MULA_DD_LH_LDINC => "mula.dd.lh.ldinc",
            MULA_DD_HH_LDINC => "mula.dd.hh.ldinc",
            MULA_DD_LL_LDDEC => "mula.dd.ll.lddec",
            MULA_DD_HL_LDDEC => "mula.dd.hl.lddec",
            MULA_DD_LH_LDDEC => "mula.dd.lh.lddec",
            MULA_DD_HH_LDDEC => "mula.dd.hh.lddec",
            MUL_DD_LL        => "mul.dd.ll",
            MUL_DD_HL        => "mul.dd.hl",
            MUL_DD_LH        => "mul.dd.lh",
            MUL_DD_HH        => "mul.dd.hh",
            MULA_DD_LL       => "mula.dd.ll",
            MULA_DD_HL       => "mula.dd.hl",
            MULA_DD_LH       => "mula.dd.lh",
            MULA_DD_HH       => "mula.dd.hh",
            MULS_DD_LL       => "muls.dd.ll",
            MULS_DD_HL       => "muls.dd.hl",
            MULS_DD_LH       => "muls.dd.lh",
            MULS_DD_HH       => "muls.dd.hh",
            MUL_AD_LL        => "mul.ad.ll",
            MUL_AD_HL        => "mul.ad.hl",
            MUL_AD_LH        => "mul.ad.lh",
            MUL_AD_HH        => "mul.ad.hh",
            MULA_AD_LL       => "mula.ad.ll",
            MULA_AD_HL       => "mula.ad.hl",
            MULA_AD_LH       => "mula.ad.lh",
            MULA_AD_HH       => "mula.ad.hh",
            MULS_AD_LL       => "muls.ad.ll",
            MULS_AD_HL       => "muls.ad.hl",
            MULS_AD_LH       => "muls.ad.lh",
            MULS_AD_HH       => "muls.ad.hh",
            MULA_DA_LL_LDINC => "mula.da.ll.ldinc",
            MULA_DA_HL_LDINC => "mula.da.hl.ldinc",
            MULA_DA_LH_LDINC => "mula.da.lh.ldinc",
            MULA_DA_HH_LDINC => "mula.da.ll.ldinc",
            MULA_DA_LL_LDDEC => "mula.da.ll.lddec",
            MULA_DA_HL_LDDEC => "mula.da.hl.lddec",
            MULA_DA_LH_LDDEC => "mula.da.lh.lddec",
            MULA_DA_HH_LDDEC => "mula.da.hh.lddec",
            MUL_DA_LL        => "mul.da.ll",
            MUL_DA_HL        => "mul.da.hl",
            MUL_DA_LH        => "mul.da.lh",
            MUL_DA_HH        => "mul.da.hh",
            MULA_DA_LL       => "mula.da.ll",
            MULA_DA_HL       => "mula.da.hl",
            MULA_DA_LH       => "mula.da.lh",
            MULA_DA_HH       => "mula.da.hh",
            MULS_DA_LL       => "muls.da.ll",
            MULS_DA_HL       => "muls.da.hl",
            MULS_DA_LH       => "muls.da.lh",
            MULS_DA_HH       => "muls.da.hh",
            UMUL_AA_LL       => "umul.aa.ll",
            UMUL_AA_HL       => "umul.aa.hl",
            UMUL_AA_LH       => "umul.aa.lh",
            UMUL_AA_HH       => "umul.aa.hh",
            MUL_AA_LL        => "mul.aa.ll",
            MUL_AA_HL        => "mul.aa.hl",
            MUL_AA_LH        => "mul.aa.lh",
            MUL_AA_HH        => "mul.aa.hh",
            MULA_AA_LL       => "mula.aa.ll",
            MULA_AA_HL       => "mula.aa.hl",
            MULA_AA_LH       => "mula.aa.lh",
            MULA_AA_HH       => "mula.aa.hh",
            MULS_AA_LL       => "muls.aa.ll",
            MULS_AA_HL       => "muls.aa.hl",
            MULS_AA_LH       => "muls.aa.lh",
            MULS_AA_HH       => "muls.aa.hh",
            LDINC            => "ldinc",
            LDDEC            => "ldinc",
            CALL0            => "call0",
            CALL4            => "call4",
...
fn macid(opcode: u32) -> Result<Id, Error> {
    let op1 = mask!(opcode, 4, 16);

    match op1 {
        0b0000..=0b0111 => Err(Error::Reserved),
        0b1000 => Ok(Id::MULA_DD_LL_LDINC),
        0b1001 => Ok(Id::MULA_DD_HL_LDINC),
        0b1010 => Ok(Id::MULA_DD_LH_LDINC),
        0b1011 => Ok(Id::MULA_DD_HH_LDINC),
        0b1100..=0b1111 => Err(Error::Reserved),
        _ => unreachable!(),
    }
}

fn maccd(opcode: u32) -> Result<Id, Error> {
    let op1 = mask!(opcode, 4, 16);

    match op1 {
        0b0000..=0b0111 => Err(Error::Reserved),
        0b1000 => Ok(Id::MULA_DD_LL_LDDEC),
        0b1001 => Ok(Id::MULA_DD_HL_LDDEC),
        0b1010 => Ok(Id::MULA_DD_LH_LDDEC),
        0b1011 => Ok(Id::MULA_DD_HH_LDDEC),
        0b1100..=0b1111 => Err(Error::Reserved),
        _ => unreachable!(),
    }
}

fn macdd(opcode: u32) -> Result<Id, Error> {
    let op1 = mask!(opcode, 4, 16);

    match op1 {
        0b0000..=0b0011 => Err(Error::Reserved),
        0b0100 => Ok(Id::MUL_DD_LL),
        0b0101 => Ok(Id::MUL_DD_HL),
        0b0110 => Ok(Id::MUL_DD_LH),
        0b0111 => Ok(Id::MUL_DD_HH),
        0b1000 => Ok(Id::MULA_DD_LL),
        0b1001 => Ok(Id::MULA_DD_HL),
        0b1010 => Ok(Id::MULA_DD_LH),
        0b1011 => Ok(Id::MULA_DD_HH),
        0b1100 => Ok(Id::MULS_DD_LL),
        0b1101 => Ok(Id::MULS_DD_HL),
        0b1110 => Ok(Id::MULS_DD_LH),
        0b1111 => Ok(Id::MULS_DD_HH),
        _ => unreachable!(),
    }
}

fn macad(opcode: u32) -> Result<Id, Error> {
    let op1 = mask!(opcode, 4, 16);

    match op1 {
        0b0000..=0b0011 => Err(Error::Reserved),
        0b0100 => Ok(Id::MUL_AD_LL),
        0b0101 => Ok(Id::MUL_AD_HL),
        0b0110 => Ok(Id::MUL_AD_LH),
        0b0111 => Ok(Id::MUL_AD_HH),
        0b1000 => Ok(Id::MULA_AD_LL),
        0b1001 => Ok(Id::MULA_AD_HL),
        0b1010 => Ok(Id::MULA_AD_LH),
        0b1011 => Ok(Id::MULA_AD_HH),
        0b1100 => Ok(Id::MULS_AD_LL),
        0b1101 => Ok(Id::MULS_AD_HL),
        0b1110 => Ok(Id::MULS_AD_LH),
        0b1111 => Ok(Id::MULS_AD_HH),
        _ => unreachable!(),
    }
}

fn macia(opcode: u32) -> Result<Id, Error> {
    let op1 = mask!(opcode, 4, 16);

    match op1 {
        0b0000..=0b0111 => Err(Error::Reserved),
        0b1000 => Ok(Id::MULA_DA_LL_LDINC),
        0b1001 => Ok(Id::MULA_DA_HL_LDINC),
        0b1010 => Ok(Id::MULA_DA_LH_LDINC),
        0b1011 => Ok(Id::MULA_DA_HH_LDINC),
        0b1100..=0b1111 => Err(Error::Reserved),
        _ => unreachable!(),
    }
}

fn macca(opcode: u32) -> Result<Id, Error> {
    let op1 = mask!(opcode, 4, 16);

    match op1 {
        0b0000..=0b0111 => Err(Error::Reserved),
        0b1000 => Ok(Id::MULA_DA_LL_LDDEC),
        0b1001 => Ok(Id::MULA_DA_HL_LDDEC),
        0b1010 => Ok(Id::MULA_DA_LH_LDDEC),
        0b1011 => Ok(Id::MULA_DA_HH_LDDEC),
        0b1100..=0b1111 => Err(Error::Reserved),
        _ => unreachable!(),
    }
}

fn macda(opcode: u32) -> Result<Id, Error> {
    let op1 = mask!(opcode, 4, 16);

    match op1 {
        0b0000..=0b0011 => Err(Error::Reserved),
        0b0100 => Ok(Id::MUL_DA_LL),
        0b0101 => Ok(Id::MUL_DA_HL),
        0b0110 => Ok(Id::MUL_DA_LH),
        0b0111 => Ok(Id::MUL_DA_HH),
        0b1000 => Ok(Id::MULA_DA_LL),
        0b1001 => Ok(Id::MULA_DA_HL),
        0b1010 => Ok(Id::MULA_DA_LH),
        0b1011 => Ok(Id::MULA_DA_HH),
        0b1100 => Ok(Id::MULS_DA_LL),
        0b1101 => Ok(Id::MULS_DA_HL),
        0b1110 => Ok(Id::MULS_DA_LH),
        0b1111 => Ok(Id::MULS_DA_HH),
        _ => unreachable!(),
    }
}

fn macaa(opcode: u32) -> Result<Id, Error> {
    let op1 = mask!(opcode, 4, 16);

    match op1 {
        0b0000 => Ok(Id::UMUL_AA_LL),
        0b0001 => Ok(Id::UMUL_AA_HL),
        0b0010 => Ok(Id::UMUL_AA_LH),
        0b0011 => Ok(Id::UMUL_AA_HH),
        0b0100 => Ok(Id::MUL_AA_LL),
        0b0101 => Ok(Id::MUL_AA_HL),
        0b0110 => Ok(Id::MUL_AA_LH),
        0b0111 => Ok(Id::MUL_AA_HH),
        0b1000 => Ok(Id::MULA_AA_LL),
        0b1001 => Ok(Id::MULA_AA_HL),
        0b1010 => Ok(Id::MULA_AA_LH),
        0b1011 => Ok(Id::MULA_AA_HH),
        0b1100 => Ok(Id::MULS_AA_LL),
        0b1101 => Ok(Id::MULS_AA_HL),
        0b1110 => Ok(Id::MULS_AA_LH),
        0b1111 => Ok(Id::MULS_AA_HH),
        _ => unreachable!(),
    }
}

fn maci(opcode: u32) -> Result<Id, Error> {
    let op1 = mask!(opcode, 4, 16);

    match op1 {
        0b0000 => Ok(Id::LDINC),
        0b0001..=0b1111 => Err(Error::Reserved),
        _ => unreachable!(),
    }
}

fn macc(opcode: u32) -> Result<Id, Error> {
    let op1 = mask!(opcode, 4, 16);
...
fn calln(opcode: u32) -> Result<Id, Error> {
    let n = mask!(opcode, 2, 4);
...
fn b(opcode: u32) -> Result<Id, Error> {
    let r = mask!(opcode, 4, 12);
    ...
    match r {
        ...
        0b1100 => Ok(Id::BNALL),
        0b1101 => Ok(Id::BBS),
        0b1110 | 0b1111 => Ok(Id::BBSI),
        _ => unreachable!(),
    }
}

fn st2(opcode: u32) -> Result<Id, Error> {
    let t = mask!(opcode, 4, 8);

    match t {
        0b0000..=0b0111 => Ok(Id::MOVI_N),
        0b1000..=0b1011 => Ok(Id::BEQZ_N),
        0b1100..=0b1111 => Ok(Id::BNEZ_N),
        _ => unreachable!(),
    }
}
